...
class MapAxisCallback(typing.Protocol):
    def __call__(
        self, axis: builtins.str, value: builtins.int, /
    ) -> builtins.int | builtins.bool | None: ...

class MapKeyCallback(typing.Protocol):
    def __call__(
        self, key: builtins.str, value: KeyState, /
    ) -> builtins.str | builtins.bool | None: ...
...
class Mapper(NodeBase, SrcNodeBase, DstNodeBase, MapperBase):
    ...
    def snapshot(
        self, existing: typing.Optional[MapperSnapshot] = None
    ) -> typing.Optional[MapperSnapshot]: ...
...
class ChordMapper(NodeBase, SrcNodeBase, DstNodeBase, MapperBase):
    ...
    def map(
        self, src: list[builtins.str], dst: builtins.str | MapChordCallback
    ) -> None:
        r"""
