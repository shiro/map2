...
pub static ref KEY_KPD8: Key = Key::from_str(&EventType::EV_KEY, "KEY_KP8").unwrap();
pub static ref KEY_KPD9: Key = Key::from_str(&EventType::EV_KEY, "KEY_KP9").unwrap();
pub static ref KEY_F1: Key = Key::from_str(&EventType::EV_KEY, "KEY_F1").unwrap();
pub static ref KEY_F2: Key = Key::from_str(&EventType::EV_KEY, "KEY_F2").unwrap();
pub static ref KEY_F3: Key = Key::from_str(&EventType::EV_KEY, "KEY_F3").unwrap();
...
pub static ref KEY_F6: Key = Key::from_str(&EventType::EV_KEY, "KEY_F6").unwrap();
pub static ref KEY_F7: Key = Key::from_str(&EventType::EV_KEY, "KEY_F7").unwrap();
pub static ref KEY_F8: Key = Key::from_str(&EventType::EV_KEY, "KEY_F8").unwrap();
pub static ref KEY_F9: Key = Key::from_str(&EventType::EV_KEY, "KEY_F9").unwrap();
pub static ref KEY_F10: Key = Key::from_str(&EventType::EV_KEY, "KEY_F10").unwrap();
pub static ref KEY_F11: Key = Key::from_str(&EventType::EV_KEY, "KEY_F11").unwrap();
pub static ref KEY_F12: Key = Key::from_str(&EventType::EV_KEY, "KEY_F12").unwrap();
pub static ref KEY_F13: Key = Key::from_str(&EventType::EV_KEY, "KEY_F13").unwrap();
pub static ref KEY_F14: Key = Key::from_str(&EventType::EV_KEY, "KEY_F14").unwrap();
pub static ref KEY_F15: Key = Key::from_str(&EventType::EV_KEY, "KEY_F15").unwrap();
pub static ref KEY_F16: Key = Key::from_str(&EventType::EV_KEY, "KEY_F16").unwrap();
pub static ref KEY_F17: Key = Key::from_str(&EventType::EV_KEY, "KEY_F17").unwrap();
pub static ref KEY_F18: Key = Key::from_str(&EventType::EV_KEY, "KEY_F18").unwrap();
pub static ref KEY_F19: Key = Key::from_str(&EventType::EV_KEY, "KEY_F19").unwrap();
pub static ref KEY_F20: Key = Key::from_str(&EventType::EV_KEY, "KEY_F20").unwrap();
pub static ref KEY_F21: Key = Key::from_str(&EventType::EV_KEY, "KEY_F21").unwrap();
pub static ref KEY_F22: Key = Key::from_str(&EventType::EV_KEY, "KEY_F22").unwrap();
pub static ref KEY_F23: Key = Key::from_str(&EventType::EV_KEY, "KEY_F23").unwrap();
pub static ref KEY_F24: Key = Key::from_str(&EventType::EV_KEY, "KEY_F24").unwrap();
