...
pub fn motion_action(input: &str) -> ParseResult<&str, KeyAction> {
    map_res(
        tuple((
            alt((tuple((ident, multispace1, ident)),)),
            multispace1,
            number,
        )),
        |((tag1, _, tag2), _, value)| {
...
mod tests {
    ...
    fn motion_action_input() {
        assert_eq!(
            ...
            nom_ok(KeyAction {
                key: Key {
                    event_code: EventCode::EV_REL(REL_X)
                },
                value: 33
            })
        );
        ...
        assert_eq!(
            ...
            nom_ok(KeyAction {
                key: Key {
                    event_code: EventCode::EV_REL(REL_Y)
                },
                value: 99
            })
        );
        ...
        assert_eq!(
            ...
            nom_ok(KeyAction {
                key: Key {
                    event_code: EventCode::EV_ABS(ABS_Z)
                },
                value: 99
            })
        );
        ...
        assert_eq!(
            ...
            nom_ok(KeyAction {
                key: Key {
                    event_code: EventCode::EV_ABS(ABS_HAT0X)
                },
                value: 1
            })
        );
        ...
        assert_eq!(
            ...
            nom_ok(KeyAction {
                key: Key {
                    event_code: EventCode::EV_ABS(ABS_TILT_X)
                },
                value: -5
            })
        );
