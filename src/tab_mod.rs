use crate::{input_event, State, TAB_DOWN, TAB_REPEAT, TAB_UP, ALT_UP, SHIFT_UP, META_UP, SYN, ALT_DOWN, SHIFT_DOWN, META_DOWN};
use std::{thread, time};
